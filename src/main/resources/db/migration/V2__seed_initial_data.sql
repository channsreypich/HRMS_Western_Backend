...
--                                                            ('admin.pich', 'admin@hrms.com', 'password123$', (SELECT id FROM roles WHERE name = 'ROLE_ADMIN')),
--                                                            ('hr.sokha', 'sokha.hr@hrms.com', 'password123$', (SELECT id FROM roles WHERE name = 'ROLE_HR')),
--                                                            ('dev.rath', 'rath.dev@hrms.com', 'password123$', (SELECT id FROM roles WHERE name = 'ROLE_EMPLOYEE')),
--                                                            ('designer.lina', 'lina.design@hrms.com', 'password123$', (SELECT id FROM roles WHERE name = 'ROLE_EMPLOYEE')),
--                                                            ('fin.borin', 'borin.fin@hrms.com', 'password123$', (SELECT id FROM roles WHERE name = 'ROLE_EMPLOYEE')),
--                                                            ('ops.vanna', 'vanna.ops@hrms.com', 'password123$', (SELECT id FROM roles WHERE name = 'ROLE_EMPLOYEE')),
--                                                            ('dev.chitra', 'chitra.dev@hrms.com', 'password123$', (SELECT id FROM roles WHERE name = 'ROLE_EMPLOYEE')),
--                                                            ('payroll.chavy', 'chavy.pay@hrms.com', 'password123$', (SELECT id FROM roles WHERE name = 'ROLE_HR')),
--                                                            ('ops.dara', 'dara.ops@hrms.com', 'password123$', (SELECT id FROM roles WHERE name = 'ROLE_EMPLOYEE')),
--                                                            ('support.nita', 'nita.sup@hrms.com', 'password123$', (SELECT id FROM roles WHERE name = 'ROLE_EMPLOYEE'));
--
-- -- =========================================================================
